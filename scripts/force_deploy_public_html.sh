...
touch "$DEST/api.php" "$DEST/includes/auth_guards.php" "$DEST/includes/platform.php" "$DEST/includes/helpers.php"

echo "--- verification ---"
grep -n "cpanel-force\|auth-guards\|login-platform" "$DEST/api.php" | head
...
echo "Done. Open https://tagforge.in/api.php?r=version — expect deploy=2026-08-26-cpanel-force"
