# Jewellery Tag Printer — legacy FastAPI / React stack

**This folder is a backup of the previous application stack** (FastAPI, React, Vite, TypeScript, PostgreSQL/SQLite, Docker Compose).

The live app at the repository root is now **PHP, MySQL, HTML, CSS, JavaScript, and Bootstrap** for shared hosting.

Do not deploy this folder to shared hosting. Use it only if you need the original Python/React source.
